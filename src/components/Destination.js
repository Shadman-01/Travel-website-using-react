...
const Destination = () => {
    return (
        <div className="destination">
            ...
            volcano inside a lake inside on island.if you fancy a closer 
            ...
            text="If you're looking for a hike that's little more challenging
            but still good fora beginner mountaineer,check out Mt.
            ...
            hailway up the trail where you can take a break and drink
